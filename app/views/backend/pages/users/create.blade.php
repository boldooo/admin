                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('firstname') ? 'has-error' : '' }}">
                            ...
                            {{ Form::text('firstname', Input::get('firstname'), ['class' => 'form-control', 'placeholder' => 'Өөрийн нэр']) }}
                        ...
                        <div class="form-group {{ $errors->has('lastname') ? 'has-error' : '' }}">
                            ...
                            {{ Form::text('lastname', Input::get('lastname'), ['class' => 'form-control', 'placeholder' => 'Овог']) }}
                        ...
                        <div class="form-group {{ $errors->has('username') ? 'has-error' : '' }}">
                            ...
                            {{ Form::text('username', Input::get('username'), ['class' => 'form-control', 'placeholder' => 'Нэвтрэх нэр']) }}
